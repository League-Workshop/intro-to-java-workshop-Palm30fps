...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerhealth > 0 && dragonhealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String attack = JOptionPane.showInputDialog(
					"The dragon is about to breath its mighty fire upon you! Do you kick the dragon or yell so loud the beast is deafeaned? ");
			...
			if (playerhealth <= 0) {
				...
				JOptionPane.showMessageDialog(null,
						" You were so close young apprentice I could taste it! Try again young one!   ");
			}
			// 14. Else if the dragon's health is less than or equal to 0
			else if (dragonhealth <= 0) {
				// -- Tell the user that the dragon is dead and they took a ton of gold!
				JOptionPane.showMessageDialog(null,
						" 💰💰💰 You defeated The EVIL Dragon of Slosar! Go back to your village and bask in your glory with all your gold! Goodbye young apprentice!   ");
				// 15. Else
			}
			...
			JOptionPane.showMessageDialog(null,
					"Your Health =" +playerhealth+"Dragons Health=" +dragonhealth+" ");
		}
	}
}
